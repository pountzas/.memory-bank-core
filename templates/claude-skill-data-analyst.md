---
template_id: claude-skill-data-analyst
title: Data Analyst - Claude Skill Integration
intent: Leverage Claude AI skill for data-analyst to enhance development workflow and deliver specialized expertise
...
steps: |
  0. Verify current branch location and create feature branch if necessary: git branch --show-current, create feature/claude-data-analyst if on dev (MANDATORY - before any work)
...
dependencies: []
version: 1.0.0
notes: This template leverages the specialized Claude AI skill "data-analyst" for enhanced development capabilities. Ensure skill prerequisites are met before execution. CRITICAL - Create feature branch BEFORE any work begins. Never commit directly to dev. Always verify workspace directory location. ALWAYS use PowerShell for terminal commands. RIGHT BEFORE git add: Test skill outputs thoroughly.
learning_tags: [claude-skill, data-analyst, automation, ai-enhancement]
changelog:
  - "2025-12-19: Initial Claude skill integration template for data-analyst."
---

## Claude Skill: Data Analyst
...
### Scripts
- `analyze_missing_values.py` (file)
- `create_dashboard.py` (file)
- `impute_missing_values.py` (file)

### References
- `imputation_methods.md` (file)
...
status: todo
lane: ai-enhancement
locks: ["data-analyst-related-files"]
depends_on: []
branch: feature/claude-data-analyst
timebox_minutes: 60
```
