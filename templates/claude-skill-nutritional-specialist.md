---
template_id: claude-skill-nutritional-specialist
title: Nutritional Specialist - Claude Skill Integration
intent: Leverage Claude AI skill for nutritional-specialist to enhance development workflow and deliver specialized expertise
...
steps: |
  0. Verify current branch location and create feature branch if necessary: git branch --show-current, create feature/claude-nutritional-specialist if on dev (MANDATORY - before any work)
...
dependencies: []
version: 1.0.0
notes: This template leverages the specialized Claude AI skill "nutritional-specialist" for enhanced development capabilities. Ensure skill prerequisites are met before execution. CRITICAL - Create feature branch BEFORE any work begins. Never commit directly to dev. Always verify workspace directory location. ALWAYS use PowerShell for terminal commands. RIGHT BEFORE git add: Test skill outputs thoroughly.
learning_tags: [claude-skill, nutritional-specialist, automation, ai-enhancement]
changelog:
  - "2025-12-19: Initial Claude skill integration template for nutritional-specialist."
---

## Claude Skill: Nutritional Specialist
...
status: todo
lane: ai-enhancement
locks: ["nutritional-specialist-related-files"]
depends_on: []
branch: feature/claude-nutritional-specialist
timebox_minutes: 60
```
