---
template_id: social-media-content
title: Social Media Generator - Claude Skill Integration
intent: Leverage Claude AI skill for social-media-generator to enhance development workflow and deliver specialized expertise
...
steps: |
  0. Verify current branch location and create feature branch if necessary: git branch --show-current, create feature/claude-social-media-generator if on dev (MANDATORY - before any work)
...
dependencies: []
version: 1.0.0
notes: This template leverages the specialized Claude AI skill "social-media-generator" for enhanced development capabilities. Ensure skill prerequisites are met before execution. CRITICAL - Create feature branch BEFORE any work begins. Never commit directly to dev. Always verify workspace directory location. ALWAYS use PowerShell for terminal commands. RIGHT BEFORE git add: Test skill outputs thoroughly.
learning_tags: [claude-skill, social-media-generator, automation, ai-enhancement]
changelog:
  - "2025-12-19: Initial Claude skill integration template for social-media-generator."
---

## Claude Skill: Social Media Generator
...
### Assets
- `facebook_template.md` (file)
- `instagram_template.md` (file)
- `linkedin_template.md` (file)
- `twitter_template.md` (file)
...
status: todo
lane: ai-enhancement
locks: ["social-media-generator-related-files"]
depends_on: []
branch: feature/claude-social-media-generator
timebox_minutes: 60
```
