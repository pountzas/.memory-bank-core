---
template_id: testing-improvement
title: Test Specialist - Claude Skill Integration
intent: Leverage Claude AI skill for test-specialist to enhance development workflow and deliver specialized expertise
...
steps: |
  0. Verify current branch location and create feature branch if necessary: git branch --show-current, create feature/claude-test-specialist if on dev (MANDATORY - before any work)
...
dependencies: []
version: 1.0.0
notes: This template leverages the specialized Claude AI skill "test-specialist" for enhanced development capabilities. Ensure skill prerequisites are met before execution. CRITICAL - Create feature branch BEFORE any work begins. Never commit directly to dev. Always verify workspace directory location. ALWAYS use PowerShell for terminal commands. RIGHT BEFORE git add: Test skill outputs thoroughly.
learning_tags: [claude-skill, test-specialist, automation, ai-enhancement]
changelog:
  - "2025-12-19: Initial Claude skill integration template for test-specialist."
---

## Claude Skill: Test Specialist
...
### Scripts
- `analyze_coverage.py` (file)
- `find_untested_code.py` (file)

### References
- `bug_analysis.md` (file)
- `testing_patterns.md` (file)
...
status: todo
lane: ai-enhancement
locks: ["test-specialist-related-files"]
depends_on: []
branch: feature/claude-test-specialist
timebox_minutes: 60
```
